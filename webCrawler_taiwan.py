...
# 目標網頁的URL
url = 'https://www.ifreesite.com/phone/taiwan-area-code.htm'
...
if response.status_code == 200:
    ...
    # 將列表存儲為JSON檔案
    with open('country_codes_taiwan.json', 'w', encoding='utf-8') as f:
        json.dump(countries, f, ensure_ascii=False, indent=4)
    
    print("JSON檔案已生成：country_codes_taiwan.json")
else:
